...
# Candidate Options and votes for each candidate.
candidate_options = []
candidate_votes = {}

# Counties and votes per county.
county_list = []
county_votes = {}
...
# Track the largest county and voter turnout for that county.
winning_county = ""
...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        county_results = (
            f"{county_name}: {county_vote_percentage:.1f}% ({votes_for_each_county:,})\n")
    ...
    for candidate_name in candidate_votes:
        ...
        # Save the vote count and percentage to the text file.
